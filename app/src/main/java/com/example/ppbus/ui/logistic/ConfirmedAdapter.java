...
public class ConfirmedAdapter extends RecyclerView.Adapter<ConfirmedAdapter.MyViewHolder> {

    private List<Packages2> packages2List = new ArrayList<>();
    private ViewModel viewModel;

    public ConfirmedAdapter(ViewModel viewModel) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.cell_confirmed, parent, false);
