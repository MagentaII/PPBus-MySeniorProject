...
public class TransitAdapter extends RecyclerView.Adapter<TransitAdapter.MyViewHolder> {

    private List<Packages2> packages2List = new ArrayList<>();
    private ViewModel viewModel;

    public TransitAdapter(ViewModel viewModel) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.cell_transit, parent, false);
